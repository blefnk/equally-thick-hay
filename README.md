...
- **🚀 Live Demo**: [equally-thick-hay.vercel.app](https://equally-thick-hay.vercel.app/en)
- **💙 Discord**: [discord.gg/Pb8uKbwpsJ](https://discord.gg/Pb8uKbwpsJ)
- **📚 Docs**: [docs.reliverse.org](https://docs.reliverse.org/equally-thick-hay)
...
1. `git clone https://github.com/blefnk/equally-thick-hay.git`
2. `cd equally-thick-hay`
3. `bun i`
